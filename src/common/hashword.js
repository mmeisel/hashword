import * as CryptoJS from '../../lib/sha3';
import * as tld from '../../lib/tld';

export default class {
    // Encoder than can be passed to crypto-js to stringify the hash
    static encoder(requireSymbols) {
        const CHAR_CLASSES = [
